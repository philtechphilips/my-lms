...
<section class="course-info">
    <div class="course-info-row">
        <div class="course-info-right">
            <div class="course-info-right-content">
                ...
                <div class="course-info-right-content-icons">
                    ...
                    <p style="color: var(--red-color); padding-right: 5px;">4.8 (20 Reviews)</p>
                    <p>87,663 enrolled this course</p>
                </div>
                ...
                <div class="course-info-right-what-to-learn">
                    <h1>What you'll learn</h1>
                    <div class="course-info-right-what-to-learn-body">
                        <p><span><i class="fa-solid fa-check"></i></span>Create their own Python Programs</p>
                        <p><span><i class="fa-solid fa-check"></i></span>Create their own Python Programs</p>
                        <p><span><i class="fa-solid fa-check"></i></span>Create their own Python Programs</p>
                        <p><span><i class="fa-solid fa-check"></i></span>Create their own Python Programs</p>
                    </div>
                ...
                <div class="cont" style="margin-top: 50px; width: 100%; margin-left: -2px;">
                    <h1 style="font-size: 24px">Course Content</h1>
                    <div class="content">
                      <div class="accordion_item" style="border: solid 1px #efefef">
                        ...
                        <div class="accordion_content" style="margin-top: 15px;">
                          ...
                          <p style="font-size: 15px; font-weight: 500;">
                            About the SAA-C03 update
                          </p>
                        </div>
                      </div>
                      <div class="accordion_item" style="background-color: #bef264;">
                      ...
                      <div class="accordion_item" style="background-color: #6ee7b7;">
                        <div class="accordion_header">
                          <span>
                            CSS
                          </span> 
                ...
                <div class="course-info-right-requirements">
                    <h1>Requirements</h1>
                    <p><span><i class="fa-solid fa-circle-dot"></i></span>Macintosh (OSX)/ Windows(Vista and higher) Machine</p>
                    <p><span><i class="fa-solid fa-circle-dot"></i></span>Macintosh (OSX)/ Windows(Vista and higher) Machine</p>
                    <p><span><i class="fa-solid fa-circle-dot"></i></span>Macintosh (OSX)/ Windows(Vista and higher) Machine</p>
                    <p><span><i class="fa-solid fa-circle-dot"></i></span>Macintosh (OSX)/ Windows(Vista and higher) Machine</p>
                </div>
                <div class="course-info-right-desc">
                    <h1>Description</h1>
                   <p>
        ...
        <div class="course-info-left">
            <div class="course-info-left-box">
                <div class="course-info-left-content">
                    <h2 style="font-weight: 400" >Inclusive Management and Leadership Skills.</h2>
                    <div class="course-info-left-content-price" style="display: flex; align-items: center; margin-top: 20px;">
                        <h1>&#8358; 5,500</h1>
                        <p style="text-decoration: line-through; font-size: 16px; font-weight: 400; padding-left: 10px;">&#8358; 14,500</p>
                        <p style="font-size: 16px; font-weight: 400; padding-left: 5px;"> 63% off</p>
                    </div>
                    <div class="purchase-course-button">
                        <a href="#" class="course-info-left-content-button">Buy Course</a>
                    </div>
                    <div class="course-info-left-content-include" style="margin-top: 20px">
                        <h3 style="margin-bottom: 15px">This course includes:</h3>
                        <p style="padding-bottom: 10px;"><span style="padding-right: 8px;"><i class="fa-solid fa-video"></i></span>14 hours on-demand video</p>
                        <p style="padding-bottom: 10px;"><span style="padding-right: 8px;"><i class="fa-solid fa-file"></i></span>1 article</p>
                        <p style="padding-bottom: 10px;"><span style="padding-right: 8px;"><i class="fa-solid fa-folder"></i></span>3 downloadable resources</p>
                        <p style="padding-bottom: 10px;"><span style="padding-right: 8px;"><i class="fa-solid fa-infinity"></i></span>Full lifetime access</p>
                    </div>
                </div>
            </div>
        </div>
...
accordion_item.forEach((item) => {
  ...
  accordion_header_item.addEventListener("click", () => {
    ...
    const item_actived = document.querySelector(".act");
...
function VerifyActive(item, content, content_actived) {
  ...
  if (content_actived) {
    ...
    content_actived.classList.remove("act");
  }

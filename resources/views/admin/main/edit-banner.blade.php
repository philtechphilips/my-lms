...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Edit Banner
@endsection
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <span>Edit Banner Text</span>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Administrator</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Banner Text</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card-body ">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input id="banner" class="form-control" placeholder="Enter New Banner Text" value="{{$old->banner}}">
                                <p id="error" class="text text-danger"></p>
                            </div>

                            <div class="form-group">
                                <input type="submit" id="submit" value="Update Banner Text" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        $('#submit').click(function (e) {
           ...
           if(banner === ''){
            ...
            $.ajax({
                method: "PUT",
                url: "/administrator/update-banner/{{$old->id}}",
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'Banner Text Updated Sucessfully!'){
                        toastr.success('Banner Text Added Sucessfully!', 'Success!', {timeOut: 3000});
                        banner.val('');
                    }else{

...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Create Course
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <form id="form" method="POST" action="/administrator/create-course" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <input id="title" name="title" class="form-control" placeholder="Enter Course Title" value="{{old('title')}}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="learn" name="learn" class="form-control" placeholder="Enter What Students Will Learn Using Comma(,)">{{old('learn')}}</textarea>
                                @error('learn')
                                <p class="text text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="audience" name="audience" class="form-control" placeholder="Enter Multiple Targeted Audience Using Comma(,)">{{old('audience')}}</textarea>
                                @error('audience')
                                    <p class="text text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="requirement" name="requirement" class="form-control" placeholder="Enter Multiple Course Requirements Using Comma(,)">{{old('requirement')}}</textarea>
                                @error('requirement')
                                    <p class="text text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4 form-group">
                                    <input id="hour" type="number" name="hour" class="form-control" placeholder="00" value="{{old('hour')}}">
                                    <p>Hours</p>
                                    @error('hour')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-4 form-group">
                                    <input id="minute" type="number" name="minute" class="form-control" placeholder="00" value="{{old('minute')}}">
                                    <p>Minutes</p>
                                    @error('minute')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-4 form-group">
                                    <input id="seconds" type="number" name="seconds" class="form-control" placeholder="00" value="{{old('seconds')}}">
                                    <p>Seconds</p>
                                    @error('seconds')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input id="iniPrice" type="number" name="iniPrice" class="form-control" placeholder="Enter Initial Price" value="{{old('iniPrice')}}">
                                    @error('iniPrice')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-6 form-group">
                                    <input id="realPrice" type="number" name="realPrice" class="form-control" placeholder="Enter Real Price" value="{{old('realPrice')}}">
                                    @error('realPrice')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="tag" name="tag" class="form-control" placeholder="Enter Multiple Course Tags Seprated Using Comma(,)">{{old('tag')}}</textarea>
                                @error('tag')
                                     <p class="text text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea id="material" name="material" class="form-control" placeholder="Enter Multiple Materials Included Seprated Using Comma(,)">{{old('material')}}</textarea>
                                @error('material')
                                    <p class="text text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-navigation">
                                ...
                                <input  type="submit" id="submit" value="Upload Course" class="btn btn-primary float-right" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>

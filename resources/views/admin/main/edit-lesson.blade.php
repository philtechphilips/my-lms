...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Edit lesson
@endsection
                    ...
                    <div class="card-body ">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" name="name" class="form-control" placeholder="Lesson Name" value="{{$lesson->name}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="content" class="textarea">
                                    {!! htmlspecialchars_decode(nl2br($lesson->content)) !!}
                                </textarea>
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Update Lesson" class="btn btn-primary">
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#submit').click(function (e) {
            ...
            $.ajax({
            method: "PUT",
            url: "/administrator/edit-lesson/"+{{$id}},
            ...
            success: function (response){
                    if(response === 'Success'){
                        toastr.success('Lesson Updated', 'Success!', {timeOut: 4000});
                        setTimeout(function () {
                            location.reload(true);
                        }, 2000);
                    }else if(response === 'Error'){
                        toastr.warning("Couldn't Update Lesson", 'Error', {timeOut: 4000});
                    }else{

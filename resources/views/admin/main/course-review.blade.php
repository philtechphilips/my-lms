...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Course Review
@endsection
   ...
   function deleteStudent(id){
    swal({
        ...
        .then((willDelete) =>{
            if (willDelete) {
                $.ajax({
                    url:'/administrator/delete-c-review/'+id,
                    type: "Delete",
                    data:{
                    ...
                    success:function(response){
                        ...
                        if($("#sid"+id).remove()){
                            swal({
                                title: "Successful!",
                                text: "Course Review Deleted Sucessfully!!",
                                icon: "success",
                                buttons: true,
                                dangerMode: false,
                            }).then((result) =>{

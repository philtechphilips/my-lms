...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Edit Blog
@endsection
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Blog Post</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <form action="/administrator/updtae-blog/{{Crypt::encrypt($blog->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @if(session('message'))
                            ...
                            <div class="form-group">
                                <h6>Blog Title</h6>
                                <input type="text" id="name" name="name" value="{{ $blog->name }}" class="form-control" placeholder="Enter Blog Post Title" />
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="vision" name="blog">
                                    {!! htmlspecialchars_decode(nl2br($blog->blog)) !!}
                                </textarea>
                                @error('blog')
                                    <strong class="text text-danger">{{ $message }}</strong>
                                @enderror

            ...
            <div class="col-md-12">
                <div class="card d-flex justify-content">
                    <div class="card-header">
                        <h4 class="card-title">Upload E-Book File</h4>
                    </div>
                    <div class="card-body">
                        @if(session('message'))
                        ...
                        <form method="PUT" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Upload E-Book File" class="btn btn-danger" />
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).ready(function () {
   $('#submit').click(function(e){
    ...
    if(files.length > 0){
        ...
        $.ajax({
            url: "/administrator/upload-ebook-file-db/{{$id}}",
            method: "post",
            data: fd,
            contentType: false,
            processData: false,
            ...
            success: function(response){
                if(response.message = "E-Book Uploaded Successfully!"){
                    swal({
                                title: "Successful!",
                                ...
                                if(result){
                                    window.location.replace('/administrator/view-ebooks');
                                }
                            });

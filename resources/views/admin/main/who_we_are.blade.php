...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Who We Are
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        <form>
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Add About" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        $('#submit').click(function (e) {
           ...
           if(mission === ''){
            ...
            $.ajax({
                method: "POST",
                url: "/administrator/add-who-we-are",
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'About Added Sucessfully!'){
                        toastr.success('About Added Sucessfully!', 'Success!', {timeOut: 5000});

        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Mission</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Mission</h4>
                    </div>
                    <div class="card-body ">
                        <form>
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Update Mission" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        $('#submit').click(function (e) {
           ...
           if(mission === ''){
            ...
            $.ajax({
                method: "PUT",
                url: "/administrator/update-mission/{{$mission->id}}",
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'Mission Updated Sucessfully!'){
                        toastr.success('Mission Updated Sucessfully!', 'Success!', {timeOut: 7000});
    ...
    function deleteMission(id){
     swal({
         ...
         .then((willDelete) =>{
             if (willDelete) {
                 $.ajax({
                     url:'/administrator/delete-mission/'+id,
                     type: "Delete",
                     data:{

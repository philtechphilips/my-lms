...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Edit About Me
@endsection
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Description</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card-body ">
                        <form>
                            ...
                            <div class="form-group">
                                <h4>Edit Description <span class="text text-danger">{{Auth::user()->name}}</span></h4>
                                <textarea id="mission">
                                 {!! htmlspecialchars_decode(nl2br($description->describe)) !!}
                                </textarea>
                                <p id="error" class="text text-danger"></p>
                            </div>

                            <div class="form-group">
                                <input type="submit" id="submit" value="Update Description" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        $('#submit').click(function (e) {
           ...
           let mission = $("#mission").val();
            // alert(vision);
           if(mission === ''){
            toastr.warning('Empty Field!', 'Enter A Description!!!', {timeOut: 5000});
           }
           else{
            $.ajax({
                method: "PUT",
                url: "/administrator/update-about-me/{{$description->id}}",
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'Record Updated Sucessfully!'){
                        toastr.success('Record Updated Sucessfully!', 'Success!', {timeOut: 7000});

...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | Mission
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Mission</h4>
                    </div>
                    <div class="card-body ">
                        <form>
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Add Mission" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
           ...
           if(mission === ''){
            ...
            $.ajax({
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'Mission Added Sucessfully!'){
                        toastr.success('Mission Added Sucessfully!', 'Success!', {timeOut: 7000});

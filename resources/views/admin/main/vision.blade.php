...
@section('title')
{{getenv('APP_FULL_NAME')}} | Administrator | View Vision
@endsection
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <span>Add New Vision</span>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Administrator</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Vision</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        <form>
                            ...
                            <div class="form-group">
                                <input type="submit" id="submit" value="Add Vision" class="btn btn-primary" class="form-control">
                            </div>
                        </form>
                    </div>
                </div>
           ...
           if(vision === ''){
            ...
            $.ajax({
                ...
                success: function (response){
                    // alert(response);
                    if(response == 'Vision Added Sucessfully!'){
                        toastr.success('Vision Added Sucessfully!', 'Success!', {timeOut: 7000});

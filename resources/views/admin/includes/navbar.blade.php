            ...
            <div class="header-content">
				...
				<div class="sub-header">
					...
					<div class="d-flex align-items-center">
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">
                            @php
                                echo date('d');
                            @endphp
                        </a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1"> @php
                            echo date('m');
                        @endphp</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light"> @php
                            echo date('Y');
                        @endphp</a>
					</div>
				</div>

            ...
            <div class="header-content">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('image/'.Auth::user()->passport)}}" width="20" alt="">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/administrator/profile" class="dropdown-item ai-icon">
				...
				<div class="sub-header">
					...
					<div class="d-flex align-items-center">
						<a href="javascript:void(0);" class="btn btn-xs btn-primary mr-1">
                            @php
                                echo date('d');
                            @endphp
                        </a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary mr-1"> @php
                            echo date('m');
                        @endphp</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"> @php
                            echo date('Y');
                        @endphp</a>
					</div>
				</div>
